...
(function ($, serenity) {
    ...
    $.widget("serenity.rating", $.serenity.widget, {
        ...
        /// <inherits url="serenity.widget.html">serenity.widget</inherits>
        /// <typedef>interface Rating extends serenity.Widget</typedef>
        /// <typedef for="JQuery">serenityRating(): JQuery</typedef>
        /// <typedef for="JQuery">serenityRating(options: any): JQuery</typedef>
        /// <summary>Display a rating widget.</summary>
        ...
        html: {
            ...
            font: {
                available: Handlebars.compile("<div class='sr-rating-available' style='font-size:{{fontSize}};color:{{color}};display:inline-block;'>{{content}}</div>", { noEscape: true }),
                selected: Handlebars.compile("<div class='sr-rating-selected' style='font-size:{{fontSize}};color:{{color}};position:absolute;top:0px;left:0px;overflow:hidden;width:0px;'>{{content}}</div>", { noEscape: true }),
                highlight: Handlebars.compile("<div class='sr-rating-highlight' style='font-size:{{fontSize}};color:{{color}};position:absolute;top:0px;left:0px;width:0px;overflow:hidden;'>{{content}}</div>", { noEscape: true })
            },
            icon: {
                available: Handlebars.compile("<div class='sr-rating-available {{cssClass}}' style='height:{{height}}px;display:inline-block;width:{{width}}px;'></div>", { noEscape: true }),
                selected: Handlebars.compile("<div class='sr-rating-selected {{cssClass}}' style='height:{{height}}px;position:absolute;top:0px;left:0px;overflow:hidden;width:0px;'></div>", { noEscape: true }),
                highlight: Handlebars.compile("<div class='sr-rating-highlight {{cssClass}}' style='height:{{height}}px;position:absolute;top:0px;left:0px;width:0px;overflow:hidden;'></div>", { noEscape: true })
            },
            clear: Handlebars.compile("<i class='sr-rating-clear {{cssClass}}' data-color='{{color}}' data-highlight-color='{{highlightColor}}' style='color:{{color}};float:left;'></i>", { noEscape: true })
        },
        ...
        options: {
            ...
            /// <summary>The number of icons that equal a value of 1.</summary>
            /// <version added="2017.1" updated="2017.1" />
            step: 0.5,
        ...
        _renderFont: function () {
            ...
            this.widgets.container.append(this.html.font.available({ fontSize: this.options.font.size, color: this.options.font.availableColor, content: content }));
            this.widgets.available = this.widgets.container.find(".sr-rating-available");
            
            // Define the selected rating "icons".
            this.widgets.container.append(this.html.font.selected({ fontSize: this.options.font.size, color: this.options.font.selectedColor, content: content }));
            this.widgets.selected = this.widgets.container.find(".sr-rating-selected");
            
            // Define the highlight rating "icons".
            this.widgets.container.append(this.html.font.highlight({ fontSize: this.options.font.size, color: this.options.font.highlightColor, content: content }));
        ...
        _renderIcon: function () {
            ...
            // Display the available rating "icons".
            this.widgets.container.append(this.html.icon.available({ cssClass: this.options.icon.availableClass, height: height, width: width }));
            this.widgets.available = this.widgets.container.find(".sr-rating-available");
            
            
            // Define the selected rating "icons".
            this.widgets.container.append(this.html.icon.selected({ cssClass: this.options.icon.selectedClass, height: height }));
            this.widgets.selected = this.widgets.container.find(".sr-rating-selected");
            
            // Define the highlight rating "icons".
            this.widgets.container.append(this.html.icon.highlight({ cssClass: this.options.icon.highlightClass, height: height }));
            this.widgets.highlight = this.widgets.container.find(".sr-rating-highlight");
        },
...
/// <param name="ui.value" type="JSON Object">Rating value.</param>
/// <param name="ui.sender" type="serenity.kanban">Instance of the widget.</param>
/// <version added="2017.1" updated="2017.1" />
